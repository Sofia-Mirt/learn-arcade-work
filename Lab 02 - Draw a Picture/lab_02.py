...
arcade.draw_parabola_filled(220, 400, 270, 150, (3, 30, 31), 300)
arcade.draw_parabola_filled(260, 400, 210, 150, (3, 30, 31), 60)
arcade.draw_parabola_filled(220, 455, 265, 130, (3, 30, 31), 305)
arcade.draw_parabola_filled(260, 455, 215, 130, (3, 30, 31), 55)
arcade.draw_parabola_filled(220, 520, 260, 100, (3, 30, 31), 310)
arcade.draw_parabola_filled(260, 520, 220, 100, (3, 30, 31), 50)
arcade.draw_arc_filled(240, 625, 40, 100, (3, 30, 31), 0, 180)
arcade.draw_circle_filled(240, 540, 20, (3, 30, 31))
arcade.draw_circle_filled(240, 584, 10, (3, 30, 31))
arcade.draw_circle_filled(240, 610, 10, (3, 30, 31))

# Draw a bush.
arcade.draw_circle_filled(220, 440, 15, (3, 36, 30))
arcade.draw_circle_filled(210, 460, 15, (3, 36, 30))
arcade.draw_circle_filled(190, 465, 15, (3, 36, 30))
arcade.draw_circle_filled(175, 445, 15, (3, 36, 30))
arcade.draw_circle_filled(185, 435, 15, (3, 36, 30))
arcade.draw_circle_filled(205, 435, 15, (3, 36, 30))
arcade.draw_circle_filled(200, 450, 15, (3, 36, 30))

# Draw second bush.
arcade.draw_circle_filled(275, 420, 15, (4, 41, 35))
arcade.draw_circle_filled(265, 440, 15, (4, 41, 35))
arcade.draw_circle_filled(245, 445, 15, (4, 41, 35))
arcade.draw_circle_filled(230, 425, 15, (4, 41, 35))
arcade.draw_circle_filled(240, 415, 15, (4, 41, 35))
arcade.draw_circle_filled(260, 415, 15, (4, 41, 35))
arcade.draw_circle_filled(255, 430, 15, (4, 41, 35))
